		...
		$config = array(
			...
			'quick_links'     => array(
				...
				'feature_request_url' => array(
					...
					'link_url'   => 'https://github.com/themebeez/cream-blog-pro/issues',
					'link_class' => 'button tt-button button-secondary',
				),
			),
			// Tabs.
			...
			'getting_started'     => array(
				'free' => array(
					...
					array(
						...
						'text'                => '',
						'button_label'        => esc_html__( 'Customize', 'themebeez-toolkit' ),
						'button_link'         => esc_url( admin_url( 'customize.php?autofocus[panel]=cream_blog_pro_homepage_customization' ) ),
						'is_button'           => false,
						'recommended_actions' => false,
						'is_new_tab'          => false,
					),
					array(
						...
						'text'                => '',
						'button_label'        => esc_html__( 'Customize', 'themebeez-toolkit' ),
						'button_link'         => esc_url( admin_url( 'customize.php?autofocus[panel]=cream_blog_pro_basic_customization' ) ),
						'is_button'           => false,
						'recommended_actions' => false,
						'is_new_tab'          => false,
					),
					array(
						...
						'text'                => '',
						'button_label'        => esc_html__( 'Customize', 'themebeez-toolkit' ),
						'button_link'         => esc_url( admin_url( 'customize.php?autofocus[panel]=cream_blog_pro_advance_customization' ) ),
						'is_button'           => false,
						'recommended_actions' => false,
						'is_new_tab'          => false,
					),
