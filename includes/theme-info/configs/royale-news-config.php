	...
	function themebeez_toolkit_royale_news_config() {
		...
		$config = array(
			...
			'getting_started' => array(
				...
				'pro'  => array(
					array(
						'title'               => esc_html__( 'Responsive And Mobile Friendly', 'themebeez-toolkit' ),
						'text'                => '',
					...
					array(
						'title'               => esc_html__( 'Header Layout Variation', 'themebeez-toolkit' ),
						'text'                => '',
						'button_label'        => esc_html__( 'Learn More', 'themebeez-toolkit' ),
						'button_link'         => $pro_url,
						'is_button'           => false,
					...
					array(
						'title'               => esc_html__( 'Advance Theme Options', 'themebeez-toolkit' ),
						'text'                => '',
						'button_label'        => esc_html__( 'Learn More', 'themebeez-toolkit' ),
						'button_link'         => $pro_url,
						'is_button'           => false,
