<?php
/**
 * Theme Info Configurations - Styleblog.
 *
 * @since 1.0.0
 *
...
if ( ! function_exists( 'themebeez_toolkit_styleblog_config' ) ) {
	/**
	 * Configuration of theme page - Styleblog.
	 *
	 * @since 1.0.0
	 */
		...
		$config = array(
			...
			'quick_links'     => array(
				...
				'feature_request_url' => array(
					...
					'link_url'   => 'https://github.com/themebeez/style-blog/issues',
					'link_class' => 'button tt-button button-secondary',
				),
				'rate_review_url'     => array(
					...
					'link_url'   => 'https://wordpress.org/support/theme/style-blog/reviews/#new-post',
					'link_class' => 'button tt-button button-secondary',
				),
			),
			// Tabs.
