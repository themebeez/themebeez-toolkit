<?php
/**
 * Royale News Pro Theme Info Configurations
 *
...
if( ! function_exists( 'themebeez_toolkit_royale_news_pro_config'  ) ) {
	...
	function themebeez_toolkit_royale_news_pro_config() {
		...
		$config = array(
			...
			'welcome_title' => sprintf( esc_html__( 'Welcome to %s - ', 'themebeez-toolkit' ), 'Royale News Pro' ),
			...
			'quick_links' => array(
				...
				'demo_url' => array(
					...
					'url'  => 'https://themebeez.com/demos/?theme=royale-news-pro',
					),
