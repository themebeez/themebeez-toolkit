 ...
 */
define( 'THEMEBEEZTOOLKIT_VERSION', '1.3.3' );
...
if (
	$theme->get( 'Author' ) === 'themebeez' &&
	( in_array( $theme->get( 'TextDomain' ), $themes, true ) || in_array( themebeez_toolkit_template_name(), $themes, true ) )
) {
